...
:::file{id="adjunto-configuracion" accept=".yaml,.txt,.pdf" required="true"}
Adjunta tus configuraciones de Netplan o un documento con las capturas de las evidencias.
:::
